...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIViewController *masterViewController = [[NotesTableViewController alloc] initInManagedObjectContext:self.managedObjectContext];
    ...
    self.splitViewController.masterViewController = [self.splitViewController.viewControllers objectAtIndex:0];
    self.splitViewController.detailViewController = [self.splitViewController.viewControllers objectAtIndex:1];
    NSLog(@"Master: %@", self.splitViewController.masterViewController);
    NSLog(@"Detail: %@", self.splitViewController.detailViewController);
     */
